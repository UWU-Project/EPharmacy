...
import 'package:pill_pal/pillreminder/pages/medicineItemPage/components/CustomCard.dart';
...
class _MedicineItemPageState extends State<MedicineItemPage> {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Wrap(
                          runSpacing: 2,
                          spacing: 5,
                          children: medicineItem.tags
                              .map((tag) => Chip(
                                    label: Text(
                                      '$tag',
                                    ),
                                    backgroundColor:
                                        MyColors.TealBlue.withOpacity(0.5),
          ...
          child: Column(
            ...
            children: [
              ...
              TextButton.icon(
                ...
                onPressed: () {
                  Navigator.pushNamed(context, '/medicine_edit',
                      arguments: medicineItem);
                },
              ),
              TextButton.icon(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          content: SingleChildScrollView(
              child: Text(
            '${medicineItem.name} will be permanently deleted.',
  ...
  void onDeleteMedicine(BuildContext context) {
    widget.reminderDao
        .findReminderByMedicineId(medicineItem.id ?? 0)
        .then((reminders) {
