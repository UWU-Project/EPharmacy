...
import 'package:pill_pal/pillreminder/pages/medicineEditPage/components/PillShape.dart';
import 'package:pill_pal/theme.dart';

class MedicineEditPage extends StatefulWidget {
  const MedicineEditPage(
      {Key? key, required this.medicineDao, required this.med})
      : super(key: key);
...
class _MedicineAddPageState extends State<MedicineEditPage> {
  ...
  onSubmit() {
    ...
    Navigator.pushNamedAndRemoveUntil(
      context,
      '/medicine_item',
      ModalRoute.withName('/cabinet'),
      arguments: editedMedicine,
    );
  }
